...
public class Substring {
     ...
     *
     * @param msg the string representation of the substring
     * @param pos the position of the occurrence of the substring
     */
     ...
     *
     * @param recalc specifies if the differences should be recalculated
     ...
     *
     * @param substrings ArrayList to remove single occurrences from
